<?php
  $flag = "CTF-KALIF{C@T_AN8_F1LES_N0T_TH3_BES7_TH1NG5}";
?>
  ...
  <body>
    ...
    <main>
      <div class="container px-4 py-5" id="custom-cards">
        <h2 class="pb-2 border-bottom">House of cats v3</h2>

        <div class="row row-cols-1 row-cols-lg-3 align-items-stretch g-4 py-5">
          <?php
            if(isset($image)){
              foreach (["file", "data", "filter", "zip", "phar", "http"] as $char) {
                if (strpos($image, $char) !== false) {
            ...
            <div class="col">
              <div class="card card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow-lg" style="background-image: url(<?php echo 'image'.$x.'.png' ?>); background-size:     cover;   background-repeat:   no-repeat; background-position: center center;">
                <div class="d-flex flex-column h-100 p-5 pb-3 text-white text-shadow-1">
                  <h4 class="pt-5 mt-5 mb-4 "><a href="?image=<?php echo 'image'.$x.'.png' ?>">Article</a></h4>
                  <ul class="d-flex list-unstyled mt-auto">
                    <li class="d-flex align-items-center me-3">
                      <svg class="bi me-2" width="1em" height="1em"><use xlink:href="#geo-fill"/></svg>
                      <small>House of cats v3</small>
                    </li>
